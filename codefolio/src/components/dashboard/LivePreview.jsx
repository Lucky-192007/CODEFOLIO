    ...
    <div className={`p-6 rounded-2xl border transition-all duration-300 flex flex-col justify-between shadow-sm ${
      ...
      <div>
        <div className="flex justify-between items-center mb-4">
          ...
          <span className={`text-[10px] font-extrabold px-2.5 py-1 rounded uppercase tracking-wider border ${
            isDark
        ...
        <div className={`border rounded-2xl p-5 transition-all duration-300 shadow-inner ${
          templateId === "cyberpunk"
            ...
            : "bg-slate-50 text-slate-900 border-slate-150"
        }`}>
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className={`text-base font-extrabold tracking-tight ${
                templateId === "cyberpunk" ? "text-cyan-400" : templateId === "corporate" ? "text-slate-900" : isDark ? "text-white" : "text-slate-950"
              }`}>
                {profile.fullName || "Your Full Name"}
              </h3>
              <p className={`text-xs font-bold ${
                templateId === "cyberpunk" ? "text-pink-500" : templateId === "corporate" ? "text-blue-700" : "text-purple-500"
              }`}>
          ...
          <div className="mt-4 space-y-2">
            <div className={`p-2.5 rounded-xl text-xs flex items-center justify-between border ${
              templateId === "cyberpunk"
                ? "bg-slate-900 border-slate-800/80 text-cyan-500"
                : templateId === "corporate"
      ...
      <div className={`mt-6 flex gap-3 pt-4 border-t ${isDark ? "border-slate-800/60" : "border-slate-105"}`}>
        <Link
          to="/preview"
        ...
        >
          Launch Site
          {/* Swapped conflicting <Link /> icon with <ExternalLink /> */}
